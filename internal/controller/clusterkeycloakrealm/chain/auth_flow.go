...
func (a AuthFlow) ServeRequest(ctx context.Context, realm *keycloakApi.ClusterKeycloakRealm, keycloakAPIClient *keycloakapi.APIClient) error {
	...
	if _, err := keycloakAPIClient.Realms.SetRealmBrowserFlow(ctx, realm.Spec.RealmName, realm.Spec.AuthenticationFlow.BrowserFlow); err != nil {
