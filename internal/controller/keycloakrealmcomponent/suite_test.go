...
var _ = BeforeSuite(func() {
	...
	keycloakApiClient, err = keycloakapi.NewAPIClient(
		ctx,
	...
	err = NewRealmComponentReconciler(k8sManager.GetClient(), k8sManager.GetScheme(), h, secretref.NewSecretRef(k8sManager.GetClient())).
