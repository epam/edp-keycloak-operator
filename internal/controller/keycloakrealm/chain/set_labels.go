...
func (s SetLabels) ServeRequest(ctx context.Context, realm *keycloakApi.KeycloakRealm, keycloakAPIClient *keycloakapi.APIClient) error {
	if realm.Labels == nil {
	...
	return nextServeOrNil(ctx, s.next, realm, keycloakAPIClient)
}
