...
func nextServeOrNil(ctx context.Context, next handler.RealmHandler, realm *keycloakApi.KeycloakRealm, keycloakAPIClient *keycloakapi.APIClient) error {
	if next != nil {
		err := next.ServeRequest(ctx, realm, keycloakAPIClient)
		if err != nil {
