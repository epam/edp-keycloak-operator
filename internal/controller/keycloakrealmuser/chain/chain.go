...
func MakeChain(
	...
	ch.Use(
		NewCreateOrUpdateUser(k8sClient, kClient),
		NewSetUserPassword(k8sClient, kClient),
		NewSyncUserRoles(kClient),
		NewSyncUserGroups(kClient),
		NewSyncUserIdentityProviders(kClient),
