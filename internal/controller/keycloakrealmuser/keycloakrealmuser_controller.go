...
func (r *Reconcile) tryReconcile(ctx context.Context, instance *keycloakApi.KeycloakRealmUser) error {
	...
	if instance.Spec.KeepResource {
		if instance.GetDeletionTimestamp() != nil {
			if controllerutil.ContainsFinalizer(instance, finalizerName) {
				if err := chain.NewRemoveUser(keycloakAPIClient).ServeRequest(ctx, instance, realmName); err != nil {
	...
	if err := chain.MakeChain(r.client, keycloakAPIClient).Serve(ctx, instance, realmName); err != nil {
