...
func (r *ReconcileKeycloakClient) initializeReconciliation(ctx context.Context, request reconcile.Request) (*keycloakApi.KeycloakClient, *keycloakapi.APIClient, string, error) {
...
func (r *ReconcileKeycloakClient) handleDeletion(ctx context.Context, instance *keycloakApi.KeycloakClient, kClient *keycloakapi.APIClient, realmName string) (reconcile.Result, error) {
...
func (r *ReconcileKeycloakClient) handleReconciliation(ctx context.Context, instance *keycloakApi.KeycloakClient, kClient *keycloakapi.APIClient, realmName string) (reconcile.Result, error) {
	log := ctrl.LoggerFrom(ctx)
