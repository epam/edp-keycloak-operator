...
func TestGroupsClient_ChildGroups(t *testing.T) {
	...
	t.Run("Create Parent Group", func(t *testing.T) {
		...
		extractedID := keycloakapi.GetResourceIDFromResponse(resp)
	...
	t.Run("Create Child Group", func(t *testing.T) {
		...
		child := keycloakapi.GroupRepresentation{
			Name: &childName,
		}
...
func TestGroupsClient_GetGroup_NotFound(t *testing.T) {
	...
	group, resp, err := c.Groups.GetGroup(ctx, keycloakapi.MasterRealm, "nonexistent-group-12345")
	require.Error(t, err)
	require.True(t, keycloakapi.IsNotFound(err), "Should return 404 error for non-existent group")
...
func TestGroupsClient_UpdateGroup_NotFound(t *testing.T) {
	...
	resp, err := c.Groups.UpdateGroup(ctx, keycloakapi.MasterRealm, "nonexistent-group-12345", group)
	require.Error(t, err)
	require.True(t, keycloakapi.IsNotFound(err), "Should return 404 error for non-existent group")
	require.NotNil(t, resp, "Response should be present even for error")
}
...
func TestGroupsClient_DeleteGroup_NotFound(t *testing.T) {
	...
	resp, err := c.Groups.DeleteGroup(ctx, keycloakapi.MasterRealm, "nonexistent-group-12345")
	require.Error(t, err)
	require.True(t, keycloakapi.IsNotFound(err), "Should return 404 error for non-existent group")
	require.NotNil(t, resp, "Response should be present even for error")
}
...
func TestGroupsClient_GetChildGroups_NotFound(t *testing.T) {
	...
	children, resp, err := c.Groups.GetChildGroups(ctx, keycloakapi.MasterRealm, "nonexistent-group-12345", nil)
	require.Error(t, err)
	require.True(t, keycloakapi.IsNotFound(err), "Should return 404 error for non-existent group")
...
func TestGroupsClient_RealmRoleMappings(t *testing.T) {
	...
	var testRole *keycloakapi.RoleRepresentation
	...
	t.Run("Add Role Mappings", func(t *testing.T) {
		...
		roles := []keycloakapi.RoleRepresentation{*testRole}
...
func TestGroupsClient_ClientRoleMappings(t *testing.T) {
	...
	var testClientRole *keycloakapi.RoleRepresentation
	...
	t.Run("Add Client Role Mappings", func(t *testing.T) {
		...
		roles := []keycloakapi.RoleRepresentation{*testClientRole}
...
func TestGroupsClient_FindGroupByName(t *testing.T) {
	...
	t.Run("Find Non-Existent Group", func(t *testing.T) {
		...
		require.True(t, keycloakapi.IsNotFound(err), "Should return ErrNotFound for non-existent group")
		require.NotNil(t, resp)
	})
...
func TestGroupsClient_FindChildGroupByName(t *testing.T) {
	...
	t.Run("Create Parent Group", func(t *testing.T) {
		...
		parentGroupID = keycloakapi.GetResourceIDFromResponse(resp)
	...
	t.Run("Find Non-Existent Child Group", func(t *testing.T) {
		...
		require.True(t, keycloakapi.IsNotFound(err), "Should return ErrNotFound for non-existent child group")
		require.NotNil(t, resp)
	})
	...
	t.Run("Find Child With Non-Existent Parent", func(t *testing.T) {
		...
		require.Error(t, err)
		require.NotNil(t, resp)
		require.True(t, keycloakapi.IsNotFound(err), "Should return 404 for non-existent parent")
	})
}
...
func TestGroupsClient_FindGroupByName_MultiLevel(t *testing.T) {
	...
	t.Run("Create Root Level Group", func(t *testing.T) {
		...
		rootGroupID = keycloakapi.GetResourceIDFromResponse(resp)
	...
	t.Run("Create Level 1 Child Group", func(t *testing.T) {
		...
		level1GroupID = keycloakapi.GetResourceIDFromResponse(resp)
	...
	t.Run("Create Level 2 Child Group", func(t *testing.T) {
		...
		level2GroupID = keycloakapi.GetResourceIDFromResponse(resp)
	...
	t.Run("Create Level 3 Child Group", func(t *testing.T) {
		...
		level3GroupID = keycloakapi.GetResourceIDFromResponse(resp)
	...
	t.Run("Cannot Find Grandchild In Root", func(t *testing.T) {
		...
		require.True(t, keycloakapi.IsNotFound(err), "Should return ErrNotFound for level3-group in root group")
		require.NotNil(t, resp)
	})
...
func TestGroupsClient_GetGroupByPath(t *testing.T) {
	...
	t.Run("Create Top-Level Group", func(t *testing.T) {
		...
		topGroupID = keycloakapi.GetResourceIDFromResponse(resp)
	...
	t.Run("Create Mid-Level Group", func(t *testing.T) {
		...
		midGroupID = keycloakapi.GetResourceIDFromResponse(resp)
	...
	t.Run("Create Bottom-Level Group", func(t *testing.T) {
		...
		bottomGroupID = keycloakapi.GetResourceIDFromResponse(resp)
	...
	t.Run("Non-Existent Path", func(t *testing.T) {
		...
		require.Error(t, err)
		require.True(t, keycloakapi.IsNotFound(err), "Should return 404 for non-existent path")
		require.Nil(t, group)
		require.NotNil(t, resp)
	})
	...
	t.Run("Non-Existent Nested Path", func(t *testing.T) {
		...
		require.Error(t, err)
		require.True(t, keycloakapi.IsNotFound(err), "Should return 404 for non-existent nested path")
		require.Nil(t, group)
		require.NotNil(t, resp)
	})
	...
	t.Run("Partial Valid Path With Invalid Leaf", func(t *testing.T) {
		...
		require.Error(t, err)
		require.True(t, keycloakapi.IsNotFound(err), "Should return 404 for invalid leaf in path")
		require.Nil(t, group)
		require.NotNil(t, resp)
	})
}
...
func TestGroupsClient_CountGroups(t *testing.T) {
	...
	_, err = c.Groups.CreateGroup(ctx, realmName, keycloakapi.GroupRepresentation{
		Name: &groupName,
	})
	require.NoError(t, err)
...
func TestGroupsClient_GetGroupMembers(t *testing.T) {
	...
	groupResp, err := c.Groups.CreateGroup(ctx, realmName, keycloakapi.GroupRepresentation{
		Name: &groupName,
	})
	require.NoError(t, err)
