...
type APIClient struct {
	...
	ClientScopes        ClientScopesClient
...
type ClientOption func(*APIClient, *clientConfig)

// WithRealm sets a custom realm (default: "master")
func WithRealm(realm string) ClientOption {
	return func(c *APIClient, cfg *clientConfig) {
		c.realm = realm
	}
}
...
// NewAPIClient creates a new KeycloakClient with the provided options.
//
// Required parameters:
...
func NewAPIClient(ctx context.Context, baseURL, clientId string, opts ...ClientOption) (*APIClient, error) {
	if baseURL == "" {
	...
	keycloakClient.ClientScopes = &clientScopesClient{client: generatedClient}
...
func (kc *APIClient) getContextLogger(ctx context.Context) logr.Logger {
	var zeroLogger logr.Logger
	if ctx != nil {
...
func (keycloakClient *APIClient) login(ctx context.Context) error {
...
func (keycloakClient *APIClient) Refresh(ctx context.Context) error {
	logger := keycloakClient.getContextLogger(ctx)
...
func (keycloakClient *APIClient) getAuthenticationFormData(
	ctx context.Context,
) (url.Values, error) {
...
func (keycloakClient *APIClient) addRequestHeaders(request *http.Request) {
	keycloakClient.mu.Lock()
...
func (keycloakClient *APIClient) newSignedJWT(
	ctx context.Context,
...
func NewSignedJWT(
	...
	tempClient := &APIClient{logger: logr.Discard()}
