...
func newOrganizationsTestRealm(t *testing.T) (*keycloakapi.KeycloakClient, string) {
	t.Helper()
...
func TestOrganizationsClient_CRUD(t *testing.T) {
	...
	resp, err := c.Organizations.CreateOrganization(ctx, realmName, keycloakapi.OrganizationRepresentation{
		Name:        &orgName,
		Alias:       &alias,
...
func TestOrganizationsClient_GetOrganizationByAlias_NotFound(t *testing.T) {
	...
	require.Error(t, err)
	require.True(t, keycloakapi.IsNotFound(err), "expected 404 for non-existent alias")
}
...
func TestOrganizationsClient_GetOrganizationByAlias(t *testing.T) {
	...
	// Create organization
	_, err := c.Organizations.CreateOrganization(ctx, realmName, keycloakapi.OrganizationRepresentation{
		Name:  &orgName,
		Alias: &alias,
		Domains: &[]keycloakapi.OrganizationDomainRepresentation{
...
func TestOrganizationsClient_DeleteOrganization_NotFound(t *testing.T) {
	...
	require.Error(t, err)
	require.True(t, keycloakapi.IsNotFound(err), "expected 404 for non-existent org ID")
}
