...
// ExampleNewAPIClient demonstrates client construction with password grant.
func ExampleNewAPIClient() {
	ctx := context.Background()

	kc, err := keycloakapi.NewAPIClient(ctx, "http://localhost:8080", "admin-cli",
...
// ExampleNewAPIClient_clientCredentials demonstrates client construction with client_credentials grant.
func ExampleNewAPIClient_clientCredentials() {
	ctx := context.Background()

	_, err := keycloakapi.NewAPIClient(ctx, "http://localhost:8080", "my-service-account",
