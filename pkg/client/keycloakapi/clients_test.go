...
func TestClientsClient_CreateClient_Conflict(t *testing.T) {
	...
	resp, err = c.Clients.CreateClient(ctx, realmName, client)
	require.Error(t, err)
	require.True(t, keycloakapi.IsConflict(err), "Should return 409 Conflict error for duplicate client")
	require.NotNil(t, resp, "Response should be present even for error")
}
...
func TestClientsClient_GetClientByClientID(t *testing.T) {
	...
	resp, err := c.Clients.CreateClient(ctx, realmName, keycloakapi.ClientRepresentation{
		ClientId: &clientId,
		Protocol: &protocol,
	})
	require.NoError(t, err)
...
func TestClientsClient_GetClientUUID(t *testing.T) {
	...
	expectedUUID := keycloakapi.GetResourceIDFromResponse(resp)
...
func TestClientsClient_UpdateAndScopeMethods(t *testing.T) {
	...
	resp, err = c.Clients.UpdateClient(ctx, realmName, clientUUID, keycloakapi.ClientRepresentation{
		ClientId:     &clientId,
		Name:         &updatedName,
		Protocol:     &protocol,
		PublicClient: &publicClient,
...
func TestClientsClient_ProtocolMapperCRUD(t *testing.T) {
	...
	mapperID := keycloakapi.GetResourceIDFromResponse(resp)
...
func TestClientsClient_RoleComposites(t *testing.T) {
	...
	_, err = c.Clients.CreateClientRole(ctx, realmName, clientUUID, keycloakapi.RoleRepresentation{
		Name:      &role1Name,
	...
	resp, err = c.Clients.AddClientRoleComposites(
		...
		[]keycloakapi.RoleRepresentation{*role2},
	)
	require.NoError(t, err)
	require.NotNil(t, resp)
...
func TestClientsClient_AddDefaultClientScope(t *testing.T) {
	...
	var targetScope *keycloakapi.ClientScopeRepresentation
...
func TestClientsClient_UpdateClientRole(t *testing.T) {
	...
	resp, err = c.Clients.UpdateClientRole(ctx, realmName, clientUUID, roleName, keycloakapi.RoleRepresentation{
		Name:        &roleName,
