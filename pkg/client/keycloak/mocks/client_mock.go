...
// ExportToken provides a mock function with no fields
...
// FeatureFlagEnabled provides a mock function with given fields: ctx, featureFlag
func (_m *MockClient) FeatureFlagEnabled(ctx context.Context, featureFlag string) (bool, error) {
...
func (_c *MockClient_FeatureFlagEnabled_Call) Return(_a0 bool, _a1 error) *MockClient_FeatureFlagEnabled_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClient_FeatureFlagEnabled_Call) RunAndReturn(run func(context.Context, string) (bool, error)) *MockClient_FeatureFlagEnabled_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClient) GetUsersProfile(ctx context.Context, realm string) (*keycloak_go_client.UserProfileConfig, error) {
	ret := _m.Called(ctx, realm)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*keycloak_go_client.UserProfileConfig, error)); ok {
		return rf(ctx, realm)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *keycloak_go_client.UserProfileConfig); ok {
		r0 = rf(ctx, realm)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockClient_GetUsersProfile_Call) Return(_a0 *keycloak_go_client.UserProfileConfig, _a1 error) *MockClient_GetUsersProfile_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClient_GetUsersProfile_Call) RunAndReturn(run func(context.Context, string) (*keycloak_go_client.UserProfileConfig, error)) *MockClient_GetUsersProfile_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClient) UpdateUsersProfile(ctx context.Context, realm string, userProfile keycloak_go_client.UserProfileConfig) (*keycloak_go_client.UserProfileConfig, error) {
	...
	var r0 *keycloak_go_client.UserProfileConfig
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, keycloak_go_client.UserProfileConfig) (*keycloak_go_client.UserProfileConfig, error)); ok {
		return rf(ctx, realm, userProfile)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, keycloak_go_client.UserProfileConfig) *keycloak_go_client.UserProfileConfig); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, keycloak_go_client.UserProfileConfig) error); ok {
...
func (_c *MockClient_UpdateUsersProfile_Call) Run(run func(ctx context.Context, realm string, userProfile keycloak_go_client.UserProfileConfig)) *MockClient_UpdateUsersProfile_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(keycloak_go_client.UserProfileConfig))
	})
	return _c
}

func (_c *MockClient_UpdateUsersProfile_Call) Return(_a0 *keycloak_go_client.UserProfileConfig, _a1 error) *MockClient_UpdateUsersProfile_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClient_UpdateUsersProfile_Call) RunAndReturn(run func(context.Context, string, keycloak_go_client.UserProfileConfig) (*keycloak_go_client.UserProfileConfig, error)) *MockClient_UpdateUsersProfile_Call {
	_c.Call.Return(run)
	return _c
}
