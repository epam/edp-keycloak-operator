...
func (el *PutClient) putKeycloakClient(ctx context.Context, keycloakClient *v1v1alpha1.KeycloakClient, adapterClient keycloak.Client) (string, error) {
	...
	if clientID != "" {
		...
		if err := adapterClient.UpdateClient(ctx, clientDto); err != nil {
...
func (el *PutClient) convertCrToDto(ctx context.Context, keycloakClient *v1v1alpha1.KeycloakClient) (*dto.Client, error) {
...
func (el *PutClient) getSecret(ctx context.Context, keycloakClient *v1v1alpha1.KeycloakClient) (string, error) {
...
func (el *PutClient) generateSecret(ctx context.Context, keycloakClient *v1v1alpha1.KeycloakClient) (string, error) {
	var clientSecret coreV1.Secret
